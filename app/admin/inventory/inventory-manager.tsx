...
function InventoryRow({ product }: { product: ProductRow }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-4 rounded-2xl border border-silver bg-white px-5 py-4">
      ...
      <button
        ...
        onClick={save}
        disabled={pending}
        className="inline-flex items-center gap-1.5 rounded-full bg-ink px-4 py-2 text-xs font-semibold text-white transition-transform hover:scale-[1.03] disabled:opacity-60"
      >
        {pending ? (
